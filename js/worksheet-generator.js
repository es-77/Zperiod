...
const WORKSHEET_PHRASE_MAP = {
    ...
    'Generated by Emmanuel Lab': {
        'zh-Hant': '由 Emmanuel Lab 生成',
        fr: 'Genere par Emmanuel Lab',
        ru: 'Сгенерировано в Emmanuel Lab',
        fa: 'تولید شده توسط Emmanuel Lab',
        ur: 'Emmanuel Lab کی جانب سے تیار کردہ',
        tl: 'Nabuo ng Emmanuel Lab'
    }
};
...
function renderWorksheet(worksheet, mode) {
    ...
    html += `
            <div class="worksheet-footer">
                <span>${tr('Generated by Emmanuel Lab', '由 Emmanuel Lab 生成')}</span>
            </div>
        </div>
    `;
...
function exportToPDF() {
    ...
    const title = tr('Emmanuel Lab — Balancing Chemical Equations Worksheet', 'Emmanuel Lab — 化学方程式配平练习');
        ...
        <tbody>
            <tr>
                <td class="print-content">
                    ...
                    <div class="doc-footer">Generated by Emmanuel Lab</div>
